...
import icon1 from "../../assets/fashionDesign.png";
import icon2 from "../../assets/graphicsDesign.png";
import icon3 from "../../assets/interiorDesign.png";
...
const SecondBanner = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <motion.div
      ...
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8, delay: 0.8, type: "spring", stiffness: 300 }}
      whileHover={{ scale: 1.05 }} // Hover effect
      // transition={{ type: "spring", stiffness: 300 }} // Smooth transition
    >
      <div className="flex justify-center mb-4">
    ...
    {/* Full Width Card */}
    <motion.div
      className="md:col-span-2 bg-white rounded-lg shadow-lg p-6 cursor-pointer"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8, delay: 1 , type: "spring", stiffness: 300}}
      whileHover={{ scale: 1.05 }} // Hover effect
